...
function argon_widgets_init() {
	...
	register_sidebar(
		array(
			...
			'id'            => 'rightbar-tools',
			'description'   => __( '右侧栏小工具 (在 "AAA 主题选项" 中选择 "三栏布局" 才会显示)', 'argon'),
...
function themeoptions_admin_menu(){
	/*后台管理面板侧栏添加选项*/
	add_menu_page(__("AAA 主题设置", 'argon'), __("AAA 主题选项", 'argon'), 'edit_themes', basename(__FILE__), 'themeoptions_page');
}
...
?>
	...
	<div>
		...
		<h1 style="color: #5e72e4;"><?php _e("AAA 主题设置", 'argon'); ?></h1>
					...
					<tr>
						...
						<td>
							<select name="argon_update_source">
								...
								<option value="solstice23top" <?php if ($argon_update_source=='solstice23top' || $argon_update_source=='abc233site'){echo 'selected';} ?>>evilxyz.xyz</option>
					...
					<tr>
						...
						<td>
							<select name="argon_hide_footer_author">
								...
								<option value="false" <?php if ($argon_hide_footer_author=='false'){echo 'selected';} ?>>Theme AAA</option>
								<option value="true" <?php if ($argon_hide_footer_author=='true'){echo 'selected';} ?>>Theme AAA</option>
							</select>
							<p class="description"></p>
						</td>
					</tr>
